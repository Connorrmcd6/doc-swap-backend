...
gs_connection = connect_to_gs("/Users/connormcdonald/Desktop/GitHub/doc-swap-backend/gcp_service_account.json")
...
for i in range(5):
    ...
    selection_pool = generate_selection_pool(user_submissions, user_status, n_sample, sample_seed)
